...
public class Dryfoodmilo2 extends AppCompatActivity {
    ...
    public void cs2col2RadioBtn(View view) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dryfoodmilo2);
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), Dryfoodmilo1.class);
                startActivity(intent);
            }
        });
