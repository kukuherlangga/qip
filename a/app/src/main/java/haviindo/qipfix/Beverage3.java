...
public class Beverage3 extends AppCompatActivity {
    ...
    public void cs3col10RadioBtn(View view) {
        boolean checked = ((RadioButton) view).isChecked();
        switch (view.getId()) {
            case R.id.Ycs3col10:
                if (checked)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        penInsert = getIntent().getStringArrayListExtra("array");
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), Beverage4.class);
                intent.putExtra("array",penInsert);
                startActivity(intent);
            }
        });
